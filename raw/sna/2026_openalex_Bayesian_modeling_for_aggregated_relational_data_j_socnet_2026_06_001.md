...
oa_status: "hybrid"
oa_url: "https://doi.org/10.1016/j.socnet.2026.06.001"
openalex_id: "https://openalex.org/W4415183218"
tags: ['Bayesian Modeling and Causal Inference']
keywords: ['Leverage (statistics)', 'Bayesian network', 'Variable-order Bayesian network', 'Bayesian probability', 'Implementation', 'Variety (cybernetics)', 'Key (lock)', 'Missing data']
source: openalex
---
...
Leverage (statistics), Bayesian network, Variable-order Bayesian network, Bayesian probability, Implementation, Variety (cybernetics), Key (lock), Missing data, Dynamic Bayesian network, Network model

## 주제 분류 (OpenAlex Topics)

- Bayesian Modeling and Causal Inference (score: 0.943)
