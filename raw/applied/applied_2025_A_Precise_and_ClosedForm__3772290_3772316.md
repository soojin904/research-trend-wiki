...
oa_status: "gold"
openalex_id: "https://openalex.org/W7117543628"
...
keywords: ['Scalability', 'Convergence (economics)', 'Similarity (geometry)', 'Node (physics)', 'Similarity measure', 'Measure (data warehouse)', 'Graph', 'Matrix (chemical analysis)']
...
- Advanced Graph Neural Networks (score: 0.565)
- Complex Network Analysis Techniques (score: 0.260)
- Graph Theory and Algorithms (score: 0.116)
