...
doi: ""
oa_status: "green"
openalex_id: "https://openalex.org/W7153696833"
...
keywords: ['Probabilistic logic', 'Interpretability', 'Topic model', 'Coherence (philosophical gambling strategy)', 'Semantics (computer science)', 'Probabilistic latent semantic analysis', 'Process (computing)', 'Statistical model']
...
Probabilistic logic, Interpretability, Topic model, Coherence (philosophical gambling strategy), Semantics (computer science), Probabilistic latent semantic analysis, Process (computing), Statistical model, Cluster analysis

## 주제 분류 (OpenAlex Topics)

- Text and Document Classification Technologies (score: 0.209)
- Advanced Text Analysis Techniques (score: 0.091)
- Topic Modeling (score: 0.071)
