---
title: "Natural Language Processing and Text Mining Using NLTK and SpaCy for Sentiment and Topic Analysis"
authors: ['Pranali L. Katore', 'Archana Vasudeo Bhoyar', 'B. Persis Urbana Ivy']
year: 2026
...
issue: "None"
pages: "286-313"
doi: "https://doi.org/10.71443/9789349552074-11"
oa_status: "gold"
openalex_id: "https://openalex.org/W7125485447"
...
keywords: ['Sentiment analysis', 'Topic model', 'Temporal annotation', 'Preprocessor', 'Python (programming language)', 'Annotation', 'Natural language', 'Visualization']
source: openalex-keyword
---

# Natural Language Processing and Text Mining Using NLTK and SpaCy for Sentiment and Topic Analysis

**저자**: Pranali L. Katore; Archana Vasudeo Bhoyar; B. Persis Urbana Ivy
**출처**: , pp.286-313
**발행일**: 2026-01-20
**DOI**: https://doi.org/10.71443/9789349552074-11
...
Sentiment analysis, Topic model, Temporal annotation, Preprocessor, Python (programming language), Annotation, Natural language, Visualization, Social media, Natural language understanding

## 주제 분류 (OpenAlex Topics)

- Sentiment Analysis and Opinion Mining (score: 0.717)
- Computational and Text Analysis Methods (score: 0.071)
- Misinformation and Its Impacts (score: 0.020)
