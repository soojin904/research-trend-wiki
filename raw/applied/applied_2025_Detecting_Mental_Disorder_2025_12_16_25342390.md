...
oa_status: "green"
openalex_id: "https://openalex.org/W4417475516"
...
keywords: ['Relevance (law)', 'Mental health', 'Social media', 'Narcissistic personality disorder', 'Binary classification', 'Binary number', 'Personality', 'Statistic']
...
Relevance (law), Mental health, Social media, Narcissistic personality disorder, Binary classification, Binary number, Personality, Statistic, Class (philosophy)

## 주제 분류 (OpenAlex Topics)

- Mental Health via Writing (score: 0.958)
- Digital Mental Health Interventions (score: 0.010)
