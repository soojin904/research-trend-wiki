---
title: "Legibot: Annotating Legislative Debate as Both Deliberative and Adversarial Practice - Evidence from the French National Assembly"
authors: ['Pierre-Carl Langlais', 'Annina Claesson', 'Manon Berriche', 'Andreï Mogoutov', 'Jean-Philippe Cointet']
year: 2025
...
doi: ""
oa_status: "green"
openalex_id: "https://openalex.org/W7134094933"
...
keywords: ['Adversarial system', 'Normative', 'Deliberative democracy', 'Argumentative', 'Legislature', 'Consistency (knowledge bases)', 'Annotation', 'Performative utterance']
...
**저자**: Pierre-Carl Langlais; Annina Claesson; Manon Berriche; Andreï Mogoutov; Jean-Philippe Cointet
**출처**: HAL (Le Centre pour la Communication Scientifique Directe)
**발행일**: 2025-12-05
**DOI**: 
...
Adversarial system, Normative, Deliberative democracy, Argumentative, Legislature, Consistency (knowledge bases), Annotation, Performative utterance, Argumentation theory

## 주제 분류 (OpenAlex Topics)

- Computational and Text Analysis Methods (score: 0.289)
- Social Media and Politics (score: 0.169)
