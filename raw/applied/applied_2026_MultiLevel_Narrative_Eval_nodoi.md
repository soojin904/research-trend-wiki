...
doi: ""
oa_status: "green"
openalex_id: "https://openalex.org/W7159891774"
query_keyword: "text analysis"
tags: ['Mental Health via Writing', 'Mental Health Research Topics', 'Topic Modeling']
keywords: ['Narrative', 'Coherence (philosophical gambling strategy)', 'Mental health', 'Embedding', 'Intervention (counseling)', 'Computational model', 'Computational linguistics']
...
Narrative, Coherence (philosophical gambling strategy), Mental health, Embedding, Intervention (counseling), Computational model, Computational linguistics

## 주제 분류 (OpenAlex Topics)

- Mental Health via Writing (score: 0.932)
- Mental Health Research Topics (score: 0.009)
