...
issue: "None"
pages: ""
doi: "https://doi.org/10.5281/zenodo.19596544"
oa_status: "green"
openalex_id: "https://openalex.org/W7154454499"
...
keywords: ['Topic model', 'Big data', 'Interpretability', 'Unstructured data', 'Analytics', 'Latent Dirichlet allocation', 'Field (mathematics)', 'Identification (biology)']
...
Topic model, Big data, Interpretability, Unstructured data, Analytics, Latent Dirichlet allocation, Field (mathematics), Identification (biology), Relevance (law), Vocabulary

## 주제 분류 (OpenAlex Topics)

- Computational and Text Analysis Methods (score: 0.378)
- Intellectual Property and Patents (score: 0.132)
- Innovation Diffusion and Forecasting (score: 0.026)
