...
oa_status: "green"
openalex_id: "https://openalex.org/W7150120547"
query_keyword: "text analysis"
tags: ['Machine Learning in Healthcare', 'Sentiment Analysis and Opinion Mining', 'Topic Modeling']
keywords: ['Categorization', 'Encoder', 'Scalability', 'Medical classification', 'SNOMED CT', 'Health informatics', 'Class (philosophy)', 'Text categorization']
...
Categorization, Encoder, Scalability, Medical classification, SNOMED CT, Health informatics, Class (philosophy), Text categorization, Deep learning

## 주제 분류 (OpenAlex Topics)

- Machine Learning in Healthcare (score: 0.289)
- Sentiment Analysis and Opinion Mining (score: 0.190)
- Topic Modeling (score: 0.108)
