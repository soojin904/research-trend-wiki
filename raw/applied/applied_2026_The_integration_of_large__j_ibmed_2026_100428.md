...
oa_status: "gold"
openalex_id: "https://openalex.org/W7168034711"
...
keywords: ['Recall', 'Dialysis', 'Workflow', 'Precision and recall', 'Key (lock)', 'Language model', 'Vascular access', 'Text messaging']
...
Recall, Dialysis, Workflow, Precision and recall, Key (lock), Language model, Vascular access, Text messaging, Central venous catheter

## 주제 분류 (OpenAlex Topics)

- Central Venous Catheters and Hemodialysis (score: 0.371)
- Artificial Intelligence in Healthcare and Education (score: 0.178)
- Topic Modeling (score: 0.077)
