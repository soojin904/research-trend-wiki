...
oa_status: "gold"
openalex_id: "https://openalex.org/W7171426678"
...
keywords: ['Embedding', 'Node (physics)', 'Exploit', 'Graph', 'Link (geometry)', 'Artificial neural network', 'Task (project management)', 'Core (optical fiber)']
...
Embedding, Node (physics), Exploit, Graph, Link (geometry), Artificial neural network, Task (project management), Core (optical fiber), Function (biology)

## 주제 분류 (OpenAlex Topics)

- Advanced Graph Neural Networks (score: 0.975)
- Complex Network Analysis Techniques (score: 0.010)
- Bioinformatics and Genomic Networks (score: 0.006)
