...
oa_status: "diamond"
openalex_id: "https://openalex.org/W7168264307"
...
keywords: ['Pipeline (software)', 'Lexical analysis', 'Sentiment analysis', 'Acronym', 'Quality (philosophy)', 'Word (group theory)', 'Educational data mining', 'Word processing']
...
**출처**: Artificial Intelligence and Applications
**발행일**: 2026-07-07
**DOI**: https://doi.org/10.47852/bonviewaia62029502
...
Pipeline (software), Lexical analysis, Sentiment analysis, Acronym, Quality (philosophy), Word (group theory), Educational data mining, Word processing, Raw data

## 주제 분류 (OpenAlex Topics)

- Sentiment Analysis and Opinion Mining (score: 0.858)
- Online Learning and Analytics (score: 0.013)
- Intelligent Tutoring Systems and Adaptive Learning (score: 0.009)
