...
oa_status: "closed"
openalex_id: "https://openalex.org/W7162142186"
query_keyword: "text analysis"
tags: ['Biomedical Text Mining and Ontologies', 'Text Readability and Simplification', 'Topic Modeling']
keywords: ['Phrase', 'Cosine similarity', 'Semantic similarity', 'Similarity (geometry)', 'Semantic analysis (machine learning)', 'Preprocessor', 'Semantics (computer science)', 'Semantic equivalence']
...
**출처**: Performance Measurement and Metrics, pp.1-13
**발행일**: 2026-05-22
**DOI**: https://doi.org/10.1108/pmm-12-2024-0069
...
Phrase, Cosine similarity, Semantic similarity, Similarity (geometry), Semantic analysis (machine learning), Preprocessor, Semantics (computer science), Semantic equivalence, Binary number

## 주제 분류 (OpenAlex Topics)

- Biomedical Text Mining and Ontologies (score: 0.429)
- Text Readability and Simplification (score: 0.136)
- Topic Modeling (score: 0.113)
