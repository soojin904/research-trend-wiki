...
tags: ['Human Mobility and Location-Based Analysis', 'Social Media and Politics', 'Health disparities and outcomes']
source: raw/2020_openalex_Collecting_large_personal_networks_in_a_j_socnet_2020_07_012.md
---

# Collecting large personal networks in a representative sample of Dutch women
**제목(한글)**: 네덜란드 여성 대표 표본에서 대규모 개인 네트워크 수집

**저자**: Gert Stulp
**출처**: Social Networks, Vol.64, pp.63–71
**발행일**: 2020-09-02
**DOI**: https://doi.org/10.1016/j.socnet.2020.07.012

## 한국어 요약

**연구질문**: 대규모 개인 네트워크(25명의 알터) 데이터를 대표 표본에서 시각적 도구를 활용해 효율적으로 수집할 수 있는가?

**방법론**:
- GENSI(시각 인터랙티브 네트워크 수집 도구) 활용
- 네덜란드 LISS 패널을 통한 18~40세 여성 758명 대표 표본 조사
- 25명 알터 + 16개 질문 + 300개 알터 간 관계 수집

**주요 결과**:
- 응답자의 97%가 25명 알터를 완전히 보고하고, 92%는 결측값 없음
- 알터 열거 3.5분, 알터 간 관계 3.6분 소요로 합리적 부담
- 시각적 도구 활용으로 대규모 개인 네트워크 수집이 충분히 실현 가능
...
Respondent, Personal network, Sample (material), Interpreter, Psychology, Data collection, Listing (finance), Missing data
