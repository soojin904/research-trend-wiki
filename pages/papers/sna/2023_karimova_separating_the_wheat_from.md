...
authors: ['Diana Karimova', 'Roger Leenders', 'Marlyne Meijerink-Bosman', 'Joris Mulder']
year: 2023
venue: "Social Networks"
tags: ['Complex Network Analysis Techniques', 'Advanced Causal Inference Techniques', 'Bayesian Modeling and Causal Inference']
source: raw/sna/2023_openalex_Separating_the_wheat_from_the_chaff_j_socnet_2023_02_006.md
---

# Separating the wheat from the chaff: Bayesian regularization in dynamic social networks

**저자**: Diana Karimova; Roger Leenders; Marlyne Meijerink-Bosman; Joris Mulder
**출처**: Social Networks, Vol.74, pp.139–155
**발행일**: 2023-03-27
**DOI**: https://doi.org/10.1016/j.socnet.2023.02.006
...
Computer science, Regularization (linguistics), Bayesian probability, Estimator, Prior probability, Overfitting, Econometrics, Event (particle physics)
