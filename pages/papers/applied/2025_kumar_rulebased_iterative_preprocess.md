---
title: "RULE-BASED ITERATIVE PREPROCESSING WITH DEEP SIAMESE GRU–BILSTM FOR EFFICIENT DOCUMENT STREAMING"
authors: ['K. Durga Hemanth Kumar']
year: 2025
venue: "Archives for Technical Sciences"
tags: ['Text and Document Classification Technologies', 'Topic Modeling', 'Information Retrieval and Search Behavior']
source: raw/applied/applied_2025_RULEBASED_ITERATIVE_PREPR_afts_2025_1834_833.md
---
...
**발행일**: 2025-12-30
**DOI**: https://doi.org/10.70102/afts.2025.1834.833
...
Preprocessor, Benchmark (surveying), Deep learning, Data pre-processing, Mean squared error, Document classification, Semantics (computer science)
